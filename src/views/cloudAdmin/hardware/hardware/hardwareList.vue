<template>
  <div>
    ...
    <hardwareResultList @reload="getList" @register="registerDrawerResult" />
...
<script setup lang="ts">
  ...
  import blackList from './component/blackList.vue';
  import addUpgrade from '/@/views/cloudAdmin/hardware/addUpgrade/addUpgrade.vue';
  import hardwareResultList from '/@/views/cloudAdmin/hardware/hardware/hardwareResultList.vue';
